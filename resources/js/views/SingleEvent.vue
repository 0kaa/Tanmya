    ...
    <div class="container">
      <div class="event">
        ...
        <div
          class="event-content"
          :class="
            this.$store.state.subscribeStatus == 'subscribe' ? 'subscribe' : ''
          "
        >
          <div class="header">
          ...
          <div class="info">
            ...
            <div
              class="price"
              :class="
                this.$store.state.subscribeStatus == 'subscribe' ? 'mb-0' : ''
              "
            >
              {{ event.price }}
            </div>
            <div
              ...
              v-if="this.$store.state.subscribeStatus == 'event'"
              @click="subscribeStep()"
            >
              اشتراك
            </div>
      ...
      <transition-group name="fade" tag="div" class="routing-animation">
        ...
        <SubscribeForm
          :key="'SubscribeForm'"
          v-if="this.$store.state.subscribeStatus == 'subscribe'"
        ></SubscribeForm>

        <Payment
          :key="'Payment'"
          v-if="this.$store.state.subscribeStep == true"
        ></Payment>
      </transition-group>
    </div>
  </main>
...
export default {
  ...
  methods: {
    subscribeStep() {
      this.$store.state.subscribeStatus = "subscribe";
