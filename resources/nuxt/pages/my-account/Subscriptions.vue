  ...
  <main class="subscriptions">
    <div class="container">
      ...
      <transition-group name="sub" tag="div" class="subscriptions-container">
        <div v-if="active == 'current'" :key="1" class="current">
          <div
          ...
          >
            ...
            <div class="pay text-center">
              ...
              >
                <div v-if="subscription.status == 'online'" class="pay-title">
                  تم الدفع أونلاين
                </div>
                <div
        ...
        <div v-if="active == 'previous'" :key="2" class="previous">
          <div
                ...
                >
                  ...
                  >
                    <path
                      ...
                      :fill="
                        subscription.rating && index <= subscription.ratingLevel
                          ? '#F7AD0E'
                          : 'none'
                      "
                      :stroke="
